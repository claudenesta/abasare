<?php require_once('../lib/db_function.php'); ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>ABASARE SACCO version: <?= $db->version??"1.0" ?></title>
  ...
  <div class="login-box-body">
    <form action="./auth/login.php" method="post" id="login_form">
      ...
      <!-- <div class="form-group has-feedback"> -->
        <input type="hidden" class="form-control" id="username" name="username" placeholder="username" value="<?= $_SESSION['user']['email'] ?>">
        <input type="hidden" class="form-control" id="checker" name="checker" value="<?= $_SESSION['checker'] ?>">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-6">
        <button type="submit" class="btn btn-primary btn-block btn-flat " name="login"><i class="fa fa-sign-in" aria-hidden="true"></i>  Change Password</button>
        </div>
        <!-- /.col -->
      </div>
      <div class="row">
...
<!--<h1><marquee>SORRY THE SYSTEM IS UNDER MAINTENANCE , PLEASE CONTACT NESTA ON 0782994921</marquee></h1> -->
