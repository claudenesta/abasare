...
<div class="col-md-12 pull-right" style="border:1px solid #1E90FF; background-color:#FDF5E6;">
 ...
 <table class="table table-sm">
				  ...
				  $id=0;
				  $Open_balance=0;
				  $sql="select * from financial_account order by date";
				  $query=mysqli_query($con,$sql); 
				  ...
				  ?>
                    <tr>
					<th style="width: 10px"><a href="account_transaction.php?code=<?php echo $id; ?>"><?php echo "#".$id; ?></a></th>
				  ...
				  <tfoot>
				   <tr>
					...
					<th align="center">Total:</th>
                      ...
                      <th style="background-color:green; color:#FFFFFF;"><?php echo number_format($Open_balance,2,'.',','); ?><br></th>
                      <th></th>
                   </tr>
				  </tfoot>
                </table>       
