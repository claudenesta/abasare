...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tax        <small>Add/Update Tax</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="https://destinytechnologies.in/inventory/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="https://destinytechnologies.in/inventory/tax">Tax List</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info ">
            ...
            <form class="form-horizontal" id="tax-form" >
              <input type="hidden" name="csrf_test_name" value="710d5e67d7c9514c31d10c2b2052e2a8">
              ...
              <div class="box-body">
                ...
                <div class="col-sm-4">
                 <input type="text" class="form-control input-sm " id="tax_name" name="tax_name" placeholder="" value="" autofocus onkeyup="shift_cursor(event,'tax')" >
                ...
                <div class="col-sm-4">
                 <input type="text" class="form-control input-sm only_currency" id="tax" name="tax" placeholder="" value="" autofocus onkeyup="shift_cursor(event,'save')">
