 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tax List        <small>View/Search Tax</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <!-- Main content -->
    <form action="../index.php" class="" id="table_form" method="post" accept-charset="utf-8">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Tax List</h3>
                            <div class="box-tools">
                <a class="btn btn-block btn-info" href="../tax/add.php">
