      ...
      <div class="row">
       ...
       <!-- form start -->
            <form action="add.php" class="form-horizontal" name="form" id="form" method="POST">
              <div class="box-body">
                ...
                <div class="col-md-5">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder=""  value="" required="" >
          ...
          <span id="email_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control no_special_char_no_space" id="phone" name="phone" placeholder="" value="" required="" >
          <span id="phone_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="tax_number" name="tax_number" required="" placeholder="" value="" >
              ...
              <div class="box-footer">
                              <div class="col-sm-8 col-sm-offset-2 text-center">
                                 <!-- <div class="col-sm-4"></div> -->
                                    ...
                                    <button type="submit" name="save" id="save" class=" btn btn-block btn-primary" title="Save Data"><i class="fa fa-save"></i> Save</button>
                                 </div>
                                 <div class="col-sm-3">
...
$sql = "INSERT INTO customers (customer_name,phone,email,tax_nmbr,country,province,district,sector,cell,village,staff) VALUES (:a,:b,:c,:d,:e,:f,:h,:i,:j,:k,:l)";
$q = $db->prepare($sql);
$q->execute(array(':a'=>$name,':b'=>$phone,':c'=>$email,':d'=>$tax,':e'=>$country,':f'=>$province,':h'=>$district,':i'=>$sector,':j'=>$cell,':k'=>$village,':l'=>$staff));
