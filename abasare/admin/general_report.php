    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="general_report.php<?= @$_GET['year']?"?year=".$_GET['year']:"" ?>">General Report</a></li>
        </ol>
      </section><br />
      <div class="col-md-12">
        <!-- ********** ALERT MESSAGE START******* -->
      ...
      <div class="row">
        ...
        $info_data = first($db, "SELECT * FROM general_setting")
        ?>
        <div class="col-md-12">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td <?php if ($interes != $source) { ?>bgcolor="red" style="color:#FFF;" <?php } else { ?>bgcolor="green" style="color:#FFF;" <?php } ?>>
                          <?php if ($interes != $source) { 
                            ?>
                            <span class="glyphicon glyphicon-remove"></label>
                            <?php 
                          } else { 
                            ?>
                            <span class="glyphicon glyphicon-ok"></label>
                            <?php 
                          }?>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td <?php if ($interes != $source) { ?>bgcolor="red" style="color:#FFF;" <?php } else { ?>bgcolor="green" style="color:#FFF;" <?php } ?>>
                          ...
                          if ($interes != $source) { 
                            ?>
                            <span class="glyphicon glyphicon-remove"></label><?php
                          } else { 
                            ?>
                            <span class="glyphicon glyphicon-ok"></label>
                            <?php 
                      ...
                      <tr class="bg-primary">
                        ...
                        <td <?php if (ceil($tot) != ceil($totint)) { ?>bgcolor="red" style="color:#FFF;" <?php } else { ?>bgcolor="green" style="color:#FFF;" <?php } ?>>
                          <?php 
                          if (ceil($tot) != ceil($totint)) { 
                            ?>
                            <span class="glyphicon glyphicon-remove"></label>
                            <?php  
                          } else { 
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo number_format(ceil($row['loan_amount'])); ?> Frws </td>
                          <td><?php echo number_format(ceil($row['interes'])); ?> Frws</td>
                        </tr>
                      <?php
                      } ?>
                      <tr style="color:#0933EF">
                        ...
                        <td><?php echo number_format(ceil($totlinter)); ?></td>
                      </tr>
