      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="user.php" method="POST" class="form-horizontal" id="category-form" enctype="multipart/form-data">
              ...
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control input-sm" id="name" name="name" placeholder="" required="" onkeyup="shift_cursor(event,'mobile')" value=""  autofocus >
          ...
          <label for="mobile" class="col-sm-2 control-label">Mobile<label class="text-danger">*</label></label>
                 <div class="col-sm-8">
                    <input type="text" class="form-control input-sm no_special_char_no_space" required="" id="mobile" name="mobile" placeholder="" value="" onkeyup="shift_cursor(event,'email')"  >
          ...
          <label for="email" class="col-sm-2 control-label">Email<label class="text-danger">*</label></label>
                  <div class="col-sm-8">
                    <input type="email" class="form-control input-sm" value=""  id="email" name="email" placeholder="" onkeyup="shift_cursor(event,'pass')">
          <span id="email_msg" style="display:none" class="text-danger"></span>
                ...
                <div class="form-group">
                 ...
                 <div class="col-sm-8">
                    <select class="form-control select2"  id="role_id" name="role_id" required="">
                       ...
                       <option  value='4'>Vise President</option>
                       <option  value='6'>Loan Committee</option>
                       <option  value='7'>Social saving Committee</option>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control input-sm"   id="new_user" name="new_user" placeholder="" required="" onkeyup="shift_cursor(event,'confirm')"  >
               ...
               <div class="col-md-5">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="password" class="form-control input-sm"   id="pass" name="pass" required="" placeholder="" onkeyup="shift_cursor(event,'confirm')"  >
					<span id="pass_msg" style="display:none" class="text-danger"></span>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="password" class="form-control input-sm"  id="confirm" name="confirm" placeholder="" required="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control input-sm"  id="about" name="about" placeholder="" required=""></textarea>
					<span id="confirm_msg" style="display:none" class="text-danger"></span>
                  </div>
                </div>
