        ...
        <ul class="nav navbar-nav">
          ...
          if($_SESSION['role']==1){
            ...
            <li class="dropdown notifications-menu">
              <a href="/admin/appliedloan.php">
                <i class="fa fa-bell-o"></i>
                <?php
                $quer=mysqli_query($con,"SELECT count(*) as unapploan FROM `member_loans` where president_status=0 AND committee_status=0 AND reject=0 ");   
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/admin/member_info.php?id=<?= $_SESSION['acc'] ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
          ...
          <li>
            <a href="./overdue_settings.php"><i class="fa fa-gears"></i><span class="label label-danger">New</span></a>
          </li>
        </ul>
      </div>
    </nav>
