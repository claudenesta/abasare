...
<form action="signatory/save-reject.php" method="POST" id="form_apply_loan" >
  <input type="hidden" name="loan_id" value="<?= $_GET['loan_id'] ?>">
  <input type="hidden" name="position" value="<?= $_GET['position'] ?>">
    <div class="modal-header bg-red ">
        <h4 class="modal-title">
          <span style="color:white">Reject Signatory Request</span>
          		...
          		<div class="row">
          			<div class="col-sm-12">
          				<div class="alert alert-warning text-center">
          					...
          					Do you realy want to reject signatory request for loan?
          				</div>
          			</div>
          		</div>
