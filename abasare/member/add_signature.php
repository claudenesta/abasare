<form action="actions/save_signature.php" method="POST" id="form_add_signature" >
    <div class="modal-header bg-primary ">
        <h4 class="modal-title">
          <span style="color:white"><i class="fa fa-pencil"></i> Add Signature  </span>
        ...
        <div class="card card-info">
          <div class="card-body">
            <div class="form-group row">
              <label for="image" class="col-sm-3 col-form-label">Signature: </label>
              <div class="col-sm-9">
                <input class="form-control form-control-sm" type="file" name="signature" />
              </div>
            </div>
          </div>
        </div>
