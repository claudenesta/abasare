  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12">
      <div class="box box-success">
        <div class="box-body">  
          <h2>Monthly Details on Loan status</h2>
          <div class="row">
            <div class="col-xs-12">
                ...
                <table  class="table table-bordered table-hover" id="example1">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th data-priority="4">Loan Amount</th>
                      <th data-priority="5">Payments</th>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td style="text-align: right;"><?= number_format($total_loans) ?> Rwf</td>
                      <td style="text-align: right;"><?= number_format($total_payments) ?> Rwf</td>
                      <td style="text-align: right;"><?= number_format($total_balance) ?> Rwf</td>
                    </tr>
                  </tfoot>
                </table>
