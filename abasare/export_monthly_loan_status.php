...
$output .= '
        <table border="1" cellspacing="0" cellpadding="3">
            ...
            <tr>
              ...
              <th class="col-xs-1" style="text-align: center; font-size: 16px">Type</th>
              <th class="col-xs-1" style="text-align: center; font-size: 16px">Date</th>
              <th class="col-xs-1" style="text-align: center; font-size: 16px">Loan Amount</th>
              <th class="col-xs-1" style="text-align: center; font-size: 16px">Paid</th>
        ...
        foreach($loans_info AS $loan){
          	...
          	$output .= '<tr>';
                ...
                $output .= '</td>';
                $output .= '<td>';
                    $output .= $loan['loanType'];
                $output .= '</td>';
                $output .= '<td>';
                    $output .= $loan['loan_date'];
                $output .= '</td>';
	          	$output .= '<td>';
    ...
    header("Content-Disposition: attachment; filename=monhtly_loan_status.xls");
    echo $output;
