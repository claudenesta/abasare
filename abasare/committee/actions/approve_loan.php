          		...
          		<div class="row">
          			<div class="col-sm-12">
          				<div class="alert alert-success text-center">
          					...
          					Do you realy want to accept loan request?
                    <div class="row">
                      <div class="col-sm-12">
                    ...
                    <?php
                    if(in_array($loan['loan_type_id'], $emergency_loan_ids)){
                      ?>
                      <div class="form-group row">
                          <label for="approved_amount" class="col-sm-4 col-form-label">
                              Approved Amount:
                          </label>
                          <div class="col-sm-8">
                              <input type="text" name="approved_amount" id="approved_amount" class="form-control">
                          </div>
                      </div>
                      <?php
                    }
