 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Purchase Report        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="https://destinytechnologies.in/inventory/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="https://destinytechnologies.in/inventory/purchase">Purchase List</a></li>
              ...
              <div class="box-body">
				...
				<label for="from_date" class="col-sm-2 control-label">From Date</label>
				  ...
				  <div class="col-sm-3">
					  <div class="input-group date">
						  ...
						  <input type="text" class="form-control pull-right datepicker" id="from_date" name="from_date" onkeyup="shift_cursor(event,'to_date')" value="23-07-2019">
				  ...
				  <label for="to_date" class="col-sm-2 control-label">To Date</label>
                   <div class="col-sm-3">
					  <div class="input-group date">
						  ...
						  <input type="text" class="form-control pull-right datepicker" id="to_date" name="to_date" onkeyup="shift_cursor(event,'category_name')" value="23-07-2019">
				...
				<div class="form-group">
				  ...
				  <option value="">-Select-</option>
					  <option value='1'>Krishna Patil</option><option value='2'>Walter Scott</option><option value='3'>Steve Roy</option><option value='4'>Glenn M</option><option value='5'>David W</option><option value='6'>Jason Roy</option><option value='7'>Aaron</option><option value='8'>Subhramaniam</option><option value='10'>aa</option>                  </select>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <table class="table table-bordered table-hover " id="report-data" >
                ...
                <tr>
                  ...
                  <th style="">Purchase Date</th>
                  <th style="">Supplier ID</th>
                  <th style="">Supplier Name</th>
                  <th style="">Invoice Total(₱  )</th>
